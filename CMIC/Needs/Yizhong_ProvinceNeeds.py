...
data = pd.read_csv(r'C:\Users\Administrator\Desktop\广西数据需求\需求1：潜在Native用户\huawei9_广西.txt',
...
data_section = data_section.loc[data_section['section_no'].notna()]  # 去除空值（存在省份为其他、中国，而section_no为空的情况）
data_section['section_no'] = data_section['section_no'].astype(np.int32)
data_section = data_section.iloc[:, [1, 2]]

pd.merge(data, data_section, how='inner', left_on='sec', right_on='section_no')[['mobileno', 'city']].to_csv(r'C:\Users\Administrator\Desktop\广西数据需求\需求1：潜在Native用户\huawei9_广西.txt',
