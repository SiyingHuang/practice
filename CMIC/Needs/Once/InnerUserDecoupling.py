...
path = r'C:\Users\Administrator\Desktop\native_main_users_half_year.txt'    # 主叫
path = r'C:\Users\Administrator\Desktop\native_called_users_half_year.txt'  # 被叫
...
ld = pd.read_csv(r'D:\中移互联网\01 - 运营室\01 - 分析组\05 - 充电\Python\[承宗]-号码剔除验证工具\blacklist\集团&专业公司-部门级别以上领导-20191101.txt',
                 ...
                 dtype={'mobileno': 'str'})
ld_1 = ld.loc[ld.mobileno != '13800000000']  # 剔除异常值

result = pd.merge(ld_1, data, how='left', on='mobileno')
result.fillna(0, inplace=True)
result.iloc[:, 5:] = result.iloc[:, 5:].astype(np.int64)
result.to_csv(r'C:\Users\Administrator\Desktop\消息被叫情况.txt',
...
pd.merge(ld, dul_num, how='inner', on='mobileno').sort_values(by='mobileno').to_excel(
    r'C:\Users\Administrator\Desktop\temp.xlsx',
    header=None, index=False)
