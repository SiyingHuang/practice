# 【核查1】
# 小米12月有效结算差异数据核查
# 原始数据：12月结算明细（已限制新增活跃日期，含有无IMEI的全量号码）
# 厂家有、我方无，差异号码量：6447713个
import pandas as pd

cj_data = pd.read_csv(r'D:\中移互联网\01 - 运营室\01 - 分析组\01 - 工作内容\【Native】\06 - 【公版结算】\小米\厂家提供12月有效明细\new_rcs_12月有效结算.txt',
                      header=None, names=['mobileno'])
our_data = pd.read_csv(r'D:\中移互联网\01 - 运营室\01 - 分析组\01 - 工作内容\【Native】\06 - 【公版结算】\小米\结算明细\限制首月活跃晚于新增\MI_NEW_201812.txt',
...
# our_data.to_csv(r'C:\Users\Administrator\Desktop\小米结算差异数据核查\20190816分析报告\3450517个.txt', header=None, index=False)
our_data['tag'] = 1
...
data_jiesuan2_2_1.to_csv(r'C:\Users\Administrator\Desktop\小米结算差异数据核查\20190816分析报告\357187个.txt',
...
data_jiesuan2_2_2.to_csv(r'C:\Users\Administrator\Desktop\小米结算差异数据核查\20190816分析报告\42451个.txt',
                         header=None, index=False)
...
tmp6.to_csv(r'C:\Users\Administrator\Desktop\小米结算差异数据核查\20190816分析报告\1408个号码.txt',
            header=None, index=False)
